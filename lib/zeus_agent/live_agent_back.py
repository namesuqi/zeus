...
LIVE_DIR = "/home/admin/live"
ZEUS_DIR = "/home/admin/zeus_agent"
LOG_DIR = "/tmp/log"
...
class RpcService(object):
    ...
    def StartAllVlcProcess(self, peer_num, url, video_format='m3u8', user='admin'):
        ...
        ************** ATTENTION ***************
        ...
        for i in range(1, peer_num + 1):
            ...
            command = 'vlc -I dummy --novideo {0} >> /home/admin/{1}_vlc.log &'.format(full_url, port)
    ...
    def format_live_url(self, port, url, video_format='m3u8'):
        ...
        return "http://127.0.0.1:{0}/live_{2}/user/simshi?url={1}".format(port, url, video_format)
