...
class SdkFlowUploadVersion1(object):
    def send_log(self):
        ...
        body_data = sdk_flow_upload_version_1
        ...
        for i in range(post_log_number):
            ...
            body_data['upload'][0]['timestamp'] = get_timestamp_now()
...
if __name__ == '__main__':
    sdk_flow_upload = SdkFlowUploadVersion1()
    sdk_flow_upload.send_log()
