...
class SdkFlowDownloadVersion1(object):
    def send_log(self):
        ...
        body_data = sdk_flow_download_version_1
        ...
        for i in range(post_log_number):
            ...
            body_data['downloads'][0]['flow'][0]['timestamp'] = get_timestamp_now()
...
if __name__ == '__main__':
    sdk_flow_download = SdkFlowDownloadVersion1()
    sdk_flow_download.send_log()
