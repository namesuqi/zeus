...
class SdkPerformanceVodVersion1(object):
    def send_log(self):
        ...
        body_data = sdk_performance_vod_version_1
        ...
        for i in range(post_log_number):
            ...
            body_data["file_id"] = file_ids[rand_index].replace("\n", "")
...
if __name__ == '__main__':
    sdk_performance_vod = SdkPerformanceVodVersion1()
    sdk_performance_vod.send_log()
