...
class server_push_disk_cache(data_provider.DataProvider):
    ...
    def make_data(self):
        ...
        return os.path.abspath(os.path.dirname(__file__)) + '/../Datafile/expect_data_file/server_push_disk_cache.txt'
