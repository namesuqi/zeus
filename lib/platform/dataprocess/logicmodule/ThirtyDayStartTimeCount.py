...
def makeexpecteddata(hour=-1):
    with open(os.path.abspath(os.path.dirname(__file__)) + '/../outputdata/DailyStartTimeCountDB.txt', 'r') as resultfile:
        orglines = resultfile.readlines()

    with open(os.path.abspath(os.path.dirname(__file__)) + '/../outputdata/DailyStartTimeCountDBWeek1.txt', 'w') as tempfile1:
    ...
    with open(os.path.abspath(os.path.dirname(__file__)) + '/../outputdata/DailyStartTimeCountDBWeek2.txt', 'w') as tempfile2:
        for line in orglines:
            tmpstr = line.split(',')[1]
            tmpcount = line.split(',')[2]
            if int(tmpstr) < 3000:
    ...
    with open(os.path.abspath(os.path.dirname(__file__)) + '/../outputdata/DailyStartTimeCountDBWeek1.txt', 'r') as resultfile1:
        orglines1 = resultfile1.readlines()

    with open(os.path.abspath(os.path.dirname(__file__)) + '/../outputdata/DailyStartTimeCountDBWeek2.txt', 'r') as resultfile2:
