...
if __name__ == "__main__":
    ...
    while count:
        ...
        net_name = ["@@@# @ddd", "12341223", "15415+222"]
        name_now = random.choice(net_name)
        # print name_now
        receive_num = random.randint(6000000, 1000000555500)
        transmit_num = random.randint(5000000, 6000000000000)
        ...
        host_id_now = random.choice(net_name)
        # print ip_now
        # print receive_num
        # print sys.argv
        lp_network(name_now, timestamp_now, "0000000000", transmit_num, ip_now1, host_id_now)
        lp_network(name_now, timestamp_now, "000000000.1111", transmit_num, ip_now2, host_id_now)
        lp_network(name_now, timestamp_now, receive_num, transmit_num, ip_now3, host_id_now)
        lp_network("", timestamp_now, receive_num, transmit_num, ip_now4, host_id_now)
        lp_network(name_now, timestamp_now, receive_num, transmit_num, ip_now5, host_id_now)
        lp_network(name_now, timestamp_now, receive_num, transmit_num, "aasasdaaa", host_id_now)
        ...
        lp_network(name_now, timestamp_now, receive_num, transmit_num, "a.a.a.a", host_id_now)
        lp_network(" ", timestamp_now, receive_num, transmit_num, ip_now10, host_id_now)
        ...
        lp_network(name_now, timestamp_now, receive_num, transmit_num, "aaa  111", host_id_now)
        ...
        lp_network("", timestamp_now, receive_num, transmit_num, ip_now17, host_id_now)
        lp_network(name_now, timestamp_now, receive_num, "", ip_now18, host_id_now)
        ...
        lp_network(name_now, timestamp_now, receive_num, transmit_num, ip_now23, "")
